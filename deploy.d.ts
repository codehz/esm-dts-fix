...
declare namespace WebAssembly {
  ...
  export class Global {
    ...
    /**
     * The value contained inside the global variable 鈥?this can be used to directly set
  ...
  /**
   * The `WebAssembly.Table()` object is a JavaScript wrapper object 鈥?an array-like structure
